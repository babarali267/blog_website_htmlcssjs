const f_logo = document.querySelector('#f_logo')
const black_logo = document.querySelector('#black_logo')

document.querySelector('#theme_swticher').addEventListener('click',()=>{
      document.querySelector('html').toggleAttribute('data-dark-mode');
      f_logo.classList.toggle('hide')
      black_logo.classList.toggle('hide')
})
